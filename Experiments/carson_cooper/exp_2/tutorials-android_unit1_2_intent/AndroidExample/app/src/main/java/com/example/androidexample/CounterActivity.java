...
public class CounterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //seperateBtn = findViewById(R.id.counter_seperate_btn);
        ...
        /* when increase btn is pressed, counter++, reset number textview */
        //seperateBtn.setOnClickListener(new View.OnClickListener() {
            //@Override
          //  public void onClick(View v) {
                //numberTxt.setText(String.valueOf(++counter));
            //}
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Number:", String.valueOf(counter));  // key-value to pass to the MainActivity
