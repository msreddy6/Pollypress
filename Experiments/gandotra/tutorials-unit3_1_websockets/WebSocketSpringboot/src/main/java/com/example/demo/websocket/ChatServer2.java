...
public class ChatServer2 {
    ...
    public void onOpen(Session session, @PathParam("username") String username) throws IOException {
        ...
        if (usernameSessionMap.containsKey(username)) {
            session.getBasicRemote().sendText("USE NEW USER_NAME PLEASE");
            session.close();
        }
        else {
            ...
            sendMessageToPArticularUser(username, username+" joined this chat!");
    ...
    public void onMessage(Session session, String message) throws IOException {
        ...
        if (message.startsWith("@")) {
            ...
            sendMessageToPArticularUser(destUserName, username+" sent the following: "+ actualMessage);
            sendMessageToPArticularUser(username, username+" sent the following: "+actualMessage);
        }
        else { // Message to whole chat
            broadcast(username + " broadcasted this message: " + message);
        }
    }
    ...
    public void onClose(Session session) throws IOException {
        ...
        broadcast(username + ": Bye. I'm disconnecting.");
    }
